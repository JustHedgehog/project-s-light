...
from LimeVisualize import LimeTabularVisualize
    ...
    while True:
        ...
        try:
            ...
            if input_type == 'tabular':
                ...
                LogService.send_message_to_kafka('INFO', "Start of LIME visualization...")
                exp = LimeTabularVisualize()
                ...
                LogService.send_message_to_kafka('INFO', "End of LIME visualization...")
                LogService.send_message_to_kafka('INFO', "Saving LIME visualization...")
            ...
            LogService.send_message_to_kafka('INFO', "LIME visualization saved...")
