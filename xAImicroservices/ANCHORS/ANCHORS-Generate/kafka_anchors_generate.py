...
from AnchorsGenerate import AnchorsTabularGenerate
...
if __name__ == "__main__":
    ...
    while True:
        ...
        try:
            ...
            model_type = post_data['modelType']
            model_file_id = post_data['modelFileId']
            ...
            if inputType == "tabular":
                ...
                LogService.send_message_to_kafka('INFO', "Start of ANCHORS object generation...")

                AnchorsTabularGenerate().generate(data, column_names, categorical_features, label_column, feature_names,
                                                  model_id, explainer_name, explainer_id, model_type,
                                                  model_file_id)

                fs.delete(ObjectId(data_id))
                LogService.send_message_to_kafka('INFO', "ANCHORS object generated...")
                LogService.send_message_to_kafka('INFO', "Saving ANCHORS object...")
            ...
            LogService.send_message_to_kafka('INFO', "ANCHORS object saved...")
