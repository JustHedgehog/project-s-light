...
from ShapGenerate import ShapTabularGenerate
    ...
    while True:
        ...
        try:
            ...
            if inputType == "tabular":
                ...
                LogService.send_message_to_kafka('INFO', "Start of SHAP object generation...")
                ShapTabularGenerate().generate(data, column_names, categorical_features, label_column, model_id,
                                               explainer_name,
                                               explainer_id, model_type, model_file_id)

                fs.delete(ObjectId(data_id))
                LogService.send_message_to_kafka('INFO', "SHAP object generated...")
                LogService.send_message_to_kafka('INFO', "Saving SHAP object...")
            ...
            LogService.send_message_to_kafka('INFO', "SHAP object saved...")
